    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            for (Map.Entry<String, Product> entry : productmap.entrySet()) {
                ...
                if (selectedproducts.size() < 2 && !selectedproducts.containsKey(entry.getKey())) {
                    ...
                    BufferedReader reader = new BufferedReader(new FileReader(new File( "/Users/guopeng/Desktop/CSP584HW1/DealMatches.txt")));
        ...
        if (selectedproducts.size() == 0) {
            ...
            for (Map.Entry<String, Product> entry : selectedproducts.entrySet()) {
                ...
                pw.print("<input type='hidden' name='type' value='" + entry.getValue().getType().toLowerCase() + "'>");
