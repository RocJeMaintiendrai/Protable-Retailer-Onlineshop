...
public class ProductRecommenderUtility {
    ...
    public static String getConnection() {
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/CSP584?useUnicode=true&characterEncoding=utf-8", "root", "admin123");
            message = "Successfull";
            return message;
        } catch (Exception e) {
    ...
    public HashMap<String, String> readOutputFile() {
        ...
        try {
            ...
            br = new BufferedReader(new FileReader(new File( "/Users/guopeng/Desktop/CSP584HW1/matrixFactorizationBasedRecommendations.csv")));
